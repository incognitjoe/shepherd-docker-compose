...
GRANT USAGE ON *.* TO 'userLookUuuup'@'%' IDENTIFIED BY 'password';
DROP USER 'userLookUuuup'@'%';
CREATE USER 'userLookUuuup'@'%' IDENTIFIED BY 'youMomaSoTh1n';
GRANT SELECT ON `SqlChalSix`.`users`  TO 'userLookUuuup'@'%';

GRANT USAGE ON *.* TO 'DnTPubUser'@'%' IDENTIFIED BY 'password';
DROP USER 'DnTPubUser'@'%';
CREATE USER 'DnTPubUser'@'%' IDENTIFIED BY 'ch3fBrownSa4useIsS00000Go0d';
GRANT SELECT ON `SQLiC5Shop`.`items` TO 'DnTPubUser'@'%';
GRANT SELECT ON `SQLiC5Shop`.`coupons` TO 'DnTPubUser'@'%';

GRANT USAGE ON *.* TO 'DnTVipUser'@'%' IDENTIFIED BY 'password';
DROP USER 'DnTVipUser'@'%';
CREATE USER 'DnTVipUser'@'%' IDENTIFIED BY 'ch3fBrownSa4useIsS00000Go0d';
GRANT SELECT ON `SQLiC5Shop`.`items` TO 'DnTVipUser'@'%';
GRANT SELECT ON `SQLiC5Shop`.`vipCoupons` TO 'DnTVipUser'@'%';

GRANT USAGE ON *.* TO 'DnTPurUser'@'%' IDENTIFIED BY 'password';
DROP USER 'DnTPurUser'@'%';
CREATE USER 'DnTPurUser'@'%' IDENTIFIED BY 'ch3fBrownSa4useIsS00000Go0d';
GRANT SELECT ON `SQLiC5Shop`.`items` TO 'DnTPurUser'@'%';
GRANT SELECT ON `SQLiC5Shop`.`coupons` TO 'DnTPurUser'@'%';
GRANT SELECT ON `SQLiC5Shop`.`vipCoupons` TO 'DnTPurUser'@'%';

GRANT USAGE ON *.* TO 'firstBloodyMessL'@'%' IDENTIFIED BY 'password';
DROP USER 'firstBloodyMessL'@'%';
CREATE USER 'firstBloodyMessL'@'%' IDENTIFIED BY 'firstBlooded';
GRANT SELECT ON `SqlInjLesson`.`tb_users` TO 'firstBloodyMessL'@'%';

GRANT USAGE ON *.* TO 'CharlieSeabrook'@'%' IDENTIFIED BY 'password';
DROP USER 'CharlieSeabrook'@'%';
CREATE USER 'CharlieSeabrook'@'%' IDENTIFIED BY 'shallowHal';
GRANT SELECT ON `SqlChalEmail`.`customers` TO 'CharlieSeabrook'@'%';

GRANT USAGE ON *.* TO 'RightGuard3d'@'%' IDENTIFIED BY 'password';
DROP USER 'RightGuard3d'@'%';
CREATE USER 'RightGuard3d'@'%' IDENTIFIED BY 'logic3Speaker';
GRANT SELECT ON `SqlChalOne`.`customers` TO 'RightGuard3d'@'%';

GRANT USAGE ON *.* TO 'HdmiNoSignal'@'%' IDENTIFIED BY 'password';
DROP USER 'HdmiNoSignal'@'%';
CREATE USER 'HdmiNoSignal'@'%' IDENTIFIED BY '1nforma1ion';
GRANT SELECT ON `SqlChalThree`.`customers` TO 'HdmiNoSignal'@'%';

GRANT USAGE ON *.* TO 'randomUserName'@'%' IDENTIFIED BY 'password';
DROP USER  'randomUserName'@'%';
CREATE USER 'randomUserName'@'%' IDENTIFIED BY 'c4utionHoT';
GRANT SELECT ON `BrokenAuthAndSessMangChalTwo`.`users` TO 'randomUserName'@'%';
GRANT UPDATE ON `BrokenAuthAndSessMangChalTwo`.`users` TO 'randomUserName'@'%';

GRANT USAGE ON *.* TO 'doveM3nCare'@'%' IDENTIFIED BY 'password';
DROP USER  'doveM3nCare'@'%';
CREATE USER 'doveM3nCare'@'%' IDENTIFIED BY 'plusm0r3';
GRANT SELECT ON `BrokenAuthAndSessMangChalThree`.`users` TO 'doveM3nCare'@'%';
GRANT UPDATE ON `BrokenAuthAndSessMangChalThree`.`users` TO 'doveM3nCare'@'%';

GRANT USAGE ON *.* TO 'murr4yFe1ld'@'%' IDENTIFIED BY 'password';
DROP USER 'murr4yFe1ld'@'%';
CREATE USER  'murr4yFe1ld'@'%' IDENTIFIED BY '4gainst3ngl4nd';
GRANT SELECT ON `directObjectRefChalOne`.`users` TO 'murr4yFe1ld'@'%';

GRANT USAGE ON *.* TO 'd3nn1sM4nely'@'%' IDENTIFIED BY 'password';
DROP USER 'd3nn1sM4nely'@'%';
CREATE USER  'd3nn1sM4nely'@'%' IDENTIFIED BY 'Pr0ductM4rket1ngIssu3s';
GRANT SELECT ON `directObjectRefChalTwo`.`users` TO 'd3nn1sM4nely'@'%';

GRANT USAGE ON *.* TO 'secureDood'@'%' IDENTIFIED BY 'password';
DROP USER 'secureDood'@'%';
CREATE USER  'secureDood'@'%' IDENTIFIED BY 'iCantEv3n';
GRANT SELECT ON `SqlChalFourSuperSecure`.`users` TO 'secureDood'@'%';

GRANT USAGE ON *.* TO 'csrfChalEnuer'@'%' IDENTIFIED BY 'password';
DROP USER 'csrfChalEnuer'@'%';
CREATE USER  'csrfChalEnuer'@'%' IDENTIFIED BY 'c4n1bUplZ';
GRANT SELECT ON `csrfChallengeEnumTokens`.`csrfTokens` TO 'csrfChalEnuer'@'%';
GRANT INSERT ON `csrfChallengeEnumTokens`.`csrfTokens` TO 'csrfChalEnuer'@'%';
GRANT UPDATE ON `csrfChallengeEnumTokens`.`csrfTokens` TO 'csrfChalEnuer'@'%';

GRANT USAGE ON *.* TO 'l3tsg0cra'@'%' IDENTIFIED BY 'password';
DROP USER  'l3tsg0cra'@'%';
CREATE USER 'l3tsg0cra'@'%' IDENTIFIED BY '83ururMa';
GRANT SELECT ON `BrokenAuthAndSessMangChalFive`.`users` TO 'l3tsg0cra'@'%';
GRANT UPDATE ON `BrokenAuthAndSessMangChalFive`.`users` TO 'l3tsg0cra'@'%';

GRANT USAGE ON *.* TO 'csrfChalFour'@'%' IDENTIFIED BY 'password';
DROP USER 'csrfChalFour'@'%';
CREATE USER  'csrfChalFour'@'%' IDENTIFIED BY 'R1n13U2pv';
GRANT SELECT ON `csrfChallengeFour`.`csrfTokens` TO 'csrfChalFour'@'%';
GRANT INSERT ON `csrfChallengeFour`.`csrfTokens` TO 'csrfChalFour'@'%';
GRANT UPDATE ON `csrfChallengeFour`.`csrfTokens` TO 'csrfChalFour'@'%';

GRANT USAGE ON *.* TO 'randomMoFoName'@'%' IDENTIFIED BY 'password';
DROP USER  'randomMoFoName'@'%';
CREATE USER 'randomMoFoName'@'%' IDENTIFIED BY 'c2zXlq_ZoT';
GRANT SELECT ON `BrokenAuthAndSessMangChalSix`.`users` TO 'randomMoFoName'@'%';

GRANT USAGE ON *.* TO 'randomFlower'@'%' IDENTIFIED BY 'password';
DROP USER  'randomFlower'@'%';
CREATE USER 'randomFlower'@'%' IDENTIFIED BY 'c21-le_6oT';
GRANT SELECT ON `BrokenAuthAndSessMangChalSeven`.`users` TO 'randomFlower'@'%';

GRANT USAGE ON *.* TO 'tSwsfUSer'@'%' IDENTIFIED BY 'password';
DROP USER 'tSwsfUSer'@'%';
CREATE USER 'tSwsfUSer'@'%' IDENTIFIED BY '9s31iusd-n';
GRANT SELECT ON `CryptShop`.`items` TO 'tSwsfUSer'@'%';
GRANT SELECT ON `CryptShop`.`coupons` TO 'tSwsfUSer'@'%';

GRANT USAGE ON *.* TO 'yourOrEll'@'%' IDENTIFIED BY 'password';
DROP USER  'yourOrEll'@'%';
CREATE USER 'yourOrEll'@'%' IDENTIFIED BY '91dj3:766f';
GRANT SELECT ON `UrlAccessThree`.`users` TO 'yourOrEll'@'%';

GRANT USAGE ON *.* TO 'r1ndomFlower'@'%' IDENTIFIED BY 'password';
DROP USER  'r1ndomFlower'@'%';
CREATE USER 'r1ndomFlower'@'%' IDENTIFIED BY 'c41-l2_6oT';
GRANT SELECT ON `sqlInjectSeven`.`users` TO 'r1ndomFlower'@'%';

GRANT USAGE ON *.* TO 'al1th3Tokens'@'%' IDENTIFIED BY 'password';
DROP USER  'al1th3Tokens'@'%';
CREATE USER 'al1th3Tokens'@'%' IDENTIFIED BY '87SDO63yUN.';
GRANT SELECT ON `securityMisconfigStealToken`.`tokens` TO 'al1th3Tokens'@'%';
GRANT INSERT ON `securityMisconfigStealToken`.`tokens` TO 'al1th3Tokens'@'%';
GRANT EXECUTE ON PROCEDURE `securityMisconfigStealToken`.`getToken` TO 'al1th3Tokens'@'%';
GRANT EXECUTE ON PROCEDURE `securityMisconfigStealToken`.`validToken`  TO 'al1th3Tokens'@'%';

GRANT USAGE ON *.* TO 'theBankMan'@'%' IDENTIFIED BY 'password';
DROP USER 'theBankMan'@'%';
CREATE USER 'theBankMan'@'%' IDENTIFIED BY 'B4ndkm.M98n';
GRANT SELECT ON `directObjectBank`.`bankAccounts` TO 'theBankMan'@'%';
GRANT INSERT ON `directObjectBank`.`bankAccounts` TO 'theBankMan'@'%';
GRANT UPDATE ON `directObjectBank`.`bankAccounts` TO 'theBankMan'@'%';
GRANT EXECUTE ON PROCEDURE `directObjectBank`.`bankAuth` TO 'theBankMan'@'%';
GRANT EXECUTE ON PROCEDURE `directObjectBank`.`currentFunds` TO 'theBankMan'@'%';
GRANT EXECUTE ON PROCEDURE `directObjectBank`.`transferFunds` TO 'theBankMan'@'%';
GRANT EXECUTE ON PROCEDURE `directObjectBank`.`createAccount` TO 'theBankMan'@'%';

GRANT USAGE ON *.* TO 'procChalUser'@'%' IDENTIFIED BY 'password';
DROP USER 'procChalUser'@'%';
CREATE USER 'procChalUser'@'%' IDENTIFIED BY 'k61dSmsM*8n';
GRANT SELECT ON `SqlChalStoredProc`.`customers` TO 'procChalUser'@'%';
GRANT EXECUTE ON PROCEDURE `SqlChalStoredProc`.`findUser` TO 'procChalUser'@'%';

GRANT USAGE ON *.* TO 'imVideoingThis'@'%' IDENTIFIED BY 'password';
DROP USER 'imVideoingThis'@'%';
CREATE USER 'imVideoingThis'@'%' IDENTIFIED BY 'auoi@7723dj';
GRANT SELECT ON `SqlPoorEscape`.`customers` TO 'imVideoingThis'@'%';